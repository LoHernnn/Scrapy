...
class CorrelationExposure:
    def __init__(self, db_config, max_correlation_exposure: float = 0.7):
        """
    ...
    def check_correlation_with_current_trades(self, new_crypto_id: int) -> Dict[str, Any]:
        ...
        # Get unique crypto_ids from current trades
        active_crypto_ids = list(set([trade['crypto_id'] for trade in current_trades]))
        
        # Get price history for the new crypto
        ...
        # Check correlation with each active crypto
